...
For a plugin to work it needs to expose some functionality to web-portal. A `__init__.py` file will allow this to happen. It will need to contain imports expected by the plugin loader, these are shown below:
